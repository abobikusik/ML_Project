        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <a className="nav-link active" onClick={() => onNavClick("home")}>
                🏠 Главная
              </a>
            </li>
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                ...
                <li>
                  <a className="dropdown-item" onClick={() => onNavClick("tv")}>
                    📺 Телевизоры
                  </a>
                </li>
              </ul>
            ...
            <li className="nav-item">
              <a
                className="nav-link"
                onClick={() => console.log("история запросов")}
              >
                📝 История запросов
              </a>
            </li>
